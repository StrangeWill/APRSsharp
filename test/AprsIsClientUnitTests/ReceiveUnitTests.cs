namespace AprsSharpUnitTests.AprsIsClient
{
    ...
    public class ReceiveUnitTests
    {
        ...
        public async Task ReceiveHandlesLogin()
        {
            ...
            string version = AprsSharp.Shared.Utilities.GetAssemblyVersion();
            string expectedLoginMessage = $"user N0CALL pass -1 vers AprsSharp {version} filter r/50.5039/4.4699/50";
